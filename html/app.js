...
function buyItem(item, zone, x3) {
    $.post('http://esx_weaponshop/buyItem', JSON.stringify({item: item, zone: zone, x3: x3}));
}

function showModal(item, zone, itemLabel, desc, price, x3){
    ...
    $(".container").click(function(){
        ...
        $(".btn-open").html(`<button class="btn-1" onclick="buyItem('`+item+`', '`+zone+`', '`+x3+`')"></button>`);
    });
